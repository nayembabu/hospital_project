...
<!--this is emp_id <?php echo $this->ion_auth->user()->row()->emp_id;?>-->
            ...
            <div class="panel-body">
                ...
                <form style="margin: -25px -15px -32px -16px; padding: 0" role="form" class="f_report" action="cashier/daily" method="post" enctype="multipart/form-data">
                        ...
                        <button style="float: left;" class="export no-print" onclick="javascript:window.print();">Print</button>
                        <span style="margin-left: 228px; font-size: 22px;" >
                            <?php
                                    $today = date('d-M-Y', strtotime("-1 days"));
                                    echo lang('income_description_date'); 
                                    echo $today;?>        
                        </span>
