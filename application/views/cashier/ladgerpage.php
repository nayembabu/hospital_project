            ...
            <div class="panel-body">
                ...
                <center>
                    ...
                    <?php   $c_id = $this->input->get('ciid');
                            ...
                            $eml = $query->row();
                        ?>
                    <p  style="margin: 0; padding: 0; font-size: 25px;"><?php echo lang('month').": ".$month."  ".$year; ?></p><p  style="margin: 0; padding: 0; font-size: 25px;"><?php echo lang('income_catagory').": ".$eml->category; ?></p>
                   <br>
                   <div style="border: 3px black solid; display: inline-block;">
                    <table cellpadding="0" cellspacing="0" border="1px solid black" style="display: inline-block; float:left; margin: 7px 15px 7px 7px;" class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <tbody>
                        <?php foreach ($inladgers as $inladger) { ?>
                            <tr>
                                <td><?php echo $inladger->date;?></td>
                                <td align="right"><?php $tti[] = $inladger->amount;
                                            echo $inladger->amount;?></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                            <tr>
