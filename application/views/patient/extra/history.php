                                ...
                                <?php foreach ($medical_histories as $medical_history) { ?>
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            ...
                                            <a class="btn btn-info btn-xs btn_width delete_button" href="medical_history/delete?id=<?php echo $medical_history->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> <?php echo lang('delete'); ?></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
