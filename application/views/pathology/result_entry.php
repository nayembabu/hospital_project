...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="">
            ...
            <form action="" method="post"  enctype="multipart/form-data" style="width: 85%; margin: ">
                    <center>
