    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            ...
            <header class="panel-heading">
                    <i class="fa fa-user"></i>      <?php echo lang('income').' '.lang('category'); ?>
                </header>
            <div class="panel-body">
                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                <th><?php echo lang('income').' '.lang('id'); ?></th> 
                        ...
                        <?php foreach ($cats as $cat) { ?>
                            <tr class="">
                                <td> <?php echo $cat->list; ?></td>
                                <td> <?php echo $cat->category; ?></td>
                                <td><?php echo $cat->stus; ?></td>

                                <td class="no-print">
                                     <a type="button" class="btn editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $cat->id; ?>"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?></a>
                                   
                                     <a class="btn delete_button" title="<?php echo lang('delete'); ?>" href="cashier/inpartdelete?id=<?php echo $cat->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="patientadd" action="cashier/incomepart" method="post" enctype="multipart/form-data">
