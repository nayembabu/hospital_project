...
<head>    
    ...
    <!-- Facebook Sharing Meta Tags -->
        ...
        <meta property="og:title" content="<?php echo $dr_info->dr_name; ?>">
        <meta property="og:description" content="<?php echo $dr_info->profile; ?> Serial: Call our Hotline Fee: <?php echo $dr_info->dr_firsttime; ?> BDT ">
        <meta property="og:url" content="https://shh.com.bd/front_view/doctor_profile?id=<?php echo $dr_info->dr_auto_id; ?>">
        <meta property="og:site_name" content="<?php echo $site_set->system_vendor; ?>">
        <meta property="article:publisher" content="https://www.facebook.com/sound.health.hospital/">
        <meta property="og:image" content="https://shh.com.bd/<?php if (!empty($dr_info->img_url)){ echo $dr_info->img_url; }else { if ($dr_info->gender == 'Male') { echo 'uploads/MaleDoctor.jpg'; }else{ echo 'uploads/FemaleDoctor.jpg'; } } ?>">
        <meta property="og:image:secure_url" content="https://shh.com.bd/<?php echo $dr_info->img_url; ?>">
...
<div class="wrapper">
    ...
    <!-- start hero -->
    <section id="hero">
        <div class="inner-banner" style="background-image:url(include/front_style/images/banner-doctors-detail.jpg)">
            <div class="container">
                <h3 class="title"><?php echo $dr_info->dept_name; ?> <br><br><big><strong><?php echo $dr_info->dr_name; ?></strong></big></h3>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="section-title col-12 clearfix">
                        <div class="float-left">
                            <h2><?php echo $dr_info->dr_name; ?></h2>
                            <p><?php echo $dr_info->profile; ?></p>
                        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-md-4 col-sm-6 p-r-0">
                        <div class="box-img box-shadow">
                            <img style="width: 450px; height: 450px;" src="<?php 
                        ...
                        <div class="opening-hours">
                            <h6><i class="zmdi zmdi-time"></i> Chamber Time </h6>
                            <ul class="list-unstyled">
                    <?php foreach ($dr_time as $timess) { ?>
                                <li>
                                    <label><i class="zmdi zmdi-chevron-right"></i> <?php echo $timess->day; ?> </label>
                                    <span><?php echo $timess->timestart; ?> - <?php echo $timess->timeend; ?></span>
                                </li>
                    <?php } ?>
                    ...
                    <div class="col-md-7 col-sm-6">
                        <div class="page-text">                           
                            <div class="doctor-cnt">
                                <p>
                                    <span>Doctor's Info</span><br>
                                    Doctor Fee : <b><?php echo $dr_info->dr_firsttime; ?>/=</b>
                                </p>
                                <p class="m-b-0 ul-title"><span>Speciality</span></p>
                                <ul class="list-unstyled">
                        <?php foreach ($dr_spcl as $spcial) { ?>
                                    <li><?php echo $spcial->dr_special; ?></li>
                        <?php } ?>
                                </ul>
                            </div>
                        </div>
